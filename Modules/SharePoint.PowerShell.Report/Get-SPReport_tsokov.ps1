function Get-SPReport
{
  ...
  #region 7.3.2.9	MANAGED PROPERTIES
   $title = 'Search Service Application Managed Properties'  
   $object = Get-SPRSearchManagedProperties -SPREnterpriseSearchServiceApplications $SPRObjects.SPREnterpriseSearchServiceApplication
   $properties = 'ServiceApplication', 'ServiceApplicationID', 'ManagedPropertyName','CrawledPropertyName','Type','MayBeDeleted','UseInScopes','Optimized'
